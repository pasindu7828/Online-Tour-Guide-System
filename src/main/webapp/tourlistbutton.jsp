...
body {
    ...
    align-items: center;
    background-image: url('images/nine-arch-bridge-ella-sri-lanka.jpg'); /* Replace with your image */
...
<div class="container">
		<a href="insertTourList.jsp">
        <button class="transparent-button">Add Tour Guide</button>
        </a>
        <button onclick="window.location.href='displayTourGuides'" class="transparent-button">View Tour Guide List</button>
