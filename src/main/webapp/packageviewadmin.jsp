...
body {
    ...
    align-items: center;
    background-image: url('images/sri-lanka_hot-air-balloon.jpg'); /* Replace with your image */
...
<div class="container">
        ...
        <button class="transparent-button">Add Package Details</button>
        </a>
        <button onclick="window.location.href='displayTourGuides'" class="transparent-button">View Package Details</button>
