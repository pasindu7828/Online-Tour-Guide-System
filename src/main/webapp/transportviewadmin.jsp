...
body {
    ...
    align-items: center;
    background-image: url('images/9c5db968-city-43529-1665972f0ba.jpg'); /* Replace with your image */
...
<div class="container">
        ...
        <button onclick="window.location.href='TransportSpecial.jsp'" class="transparent-button">View Trasport Details</button>
